  ...
  defend( amount ) {
    ...
    if( amount < 0 ) {
      return {
        ...
        'remaingHealth': this.healthLevel,
...
class Hero extends Player{
  ...
  addSuperPower( power ) {
    ...
    return superPower.push( power )
    
  }

  useSuperPower( index ) {

    return `${this.name} used ${power[ index ]}!`
  }
...
fireSpitter.addSuperPower( 'spitting fire', 'fire throwing', 'engulf in flame' )
